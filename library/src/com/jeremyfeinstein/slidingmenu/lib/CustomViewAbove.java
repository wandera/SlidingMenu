...
public class CustomViewAbove extends ViewGroup {
    ...
    public Drawable windowBackground = null;
    ...
    public void scrollTo(int x, int y) {
        // Only draw background (again on this layer) to cover the below view panels when opening. Otherwise do not
        // draw it to avoid overdraw (panels are not visible when completely covered.
        showBackground(x != 0);
        super.scrollTo(x, y);
        mScrollX = x;
